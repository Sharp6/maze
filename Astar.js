...
// A star algo based on http://www.briangrinstead.com/blog/astar-search-algorithm-in-javascript
function Astar(maze) {
  //this.maze = maze;

  this.maze = maze;
  this.start = this.maze.grid[0];
  this.end = this.maze.grid[(maze.cols*maze.rows) - 1]
